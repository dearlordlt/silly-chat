...
def store_export(session: Session, user_id: int, name: str, data: bytes, mime: str, ext: str) -> str:
    """Store generated bytes in the uploads store (owner-only, TTL-swept). Returns the id."""
    from app.models import Upload
    from app.uploads import _dir
    ...
    up = Upload(
        id=uuid.uuid4().hex, user_id=user_id, sha256=sha, kind="export",
